...
import com.juaracoding.catatankeuangan.Pages.Dashboard;
...
public class BaseTestClass {
	...
	public void getResult(ITestResult result) throws IOException {
		if(result.getStatus() == ITestResult.FAILURE) {
			String screenShotPath = com.juaracoding.catatankeuangan.utils.Utils.screenShot(driver, result.getMethod().getDescription().replace(" ", "_").toLowerCase());
